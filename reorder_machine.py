...
client_name = st.selectbox("Select client", ["Petco", "Sanborns", "El Magico", "Huevos", "Pets Table", "Inkovsky", "Baby Creisy", "Vigilancia Network", "Mr Mascotas", "Chile Massive"], index=0)
