...
addresses = {
    "test_location": "Moscow, Red Square 1, Russia"
}
...
client_name = st.selectbox("Select client", ["Petco", "Sanborns", "El Magico", "Huevos", "Pets Table", "Inkovsky", "Baby Creisy", "Vigilancia Network", "Mr Mascotas", "Senor Grischenko"], index=0)
